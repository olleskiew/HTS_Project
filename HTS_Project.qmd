...
We decided to not trim our samples with Cutadapt, due to the fact that all adapters were removed prior to uploading files into SRA archive.
This means this samples where probably used for analysis from the article. 
This approach will allow us to compere our results better.
