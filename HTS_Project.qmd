...
<img src="img/figure1.png" alt="A" style="width:100%; max-width:900px; height:350px; object-fit:contain; display:block; margin:auto;"/>
...
<img src="img/figure2.png" alt="B" style="width:100%; max-width:900px; height:350px; object-fit:contain; display:block; margin:auto;"/>
...
<img src="img/figure3.png" alt="C" style="width:100%; max-width:900px; height:350px; object-fit:contain; display:block; margin:auto;"/>
...
<img src="img/figure4.png" alt="C" style="width:100%; max-width:900px; height:350px; object-fit:contain; display:block; margin:auto;"/>
...
<img src="img/pca.png" alt="C" style="width:100%; max-width:900px; height:350px; object-fit:contain; display:block; margin:auto;"/>

<figcaption style="text-align:center; font-weight:600; margin-top:6px;">

figure 5: The plot shows a clear separation of groups along the first principal component (PC1). Tumor samples (blue) are clustered on the left side of the 0 axis, while non-tumor samples (red) are clustered on the right.

</figcaption>

</figure>

The arrangement of samples indicates a strong biological signal — the difference between tumor and healthy tissue is the main factor differentiating these samples.
...
We obtained a list of 474 downregulated genes and 960 upregulated genes.

</figure>

<figure style="margin: 0;">

<img src="img/wulkan.png" alt="C" style="width:100%; max-width:900px; height:350px; object-fit:contain; display:block; margin:auto;"/>

<figcaption style="text-align:center; font-weight:600; margin-top:6px;">

figure 6: Volcano plot illustrating differential gene expression
...
<img src="img/plot1.png" alt="C" style="width:100%; max-width:900px; height:350px; object-fit:contain; display:block; margin:auto;"/>

<figcaption style="text-align:center; font-weight:600; margin-top:6px;">

figure 7: The plot shows double increase in the number of genes included in the current analysis compared to the article. The original analysis was based on the NCBI Build 37.1 genome, which contained 26,419 meta-features, while GRCh38.2 contains 50,116. The increase is likely due to the inclusion of thousands of newly cataloged sequences.
...
<img src="img/plot2.png" alt="C" style="width:100%; max-width:900px; height:350px; object-fit:contain; display:block; margin:auto;"/>

<figcaption style="text-align:center; font-weight:600; margin-top:6px;">

figure 8: Despite the increase in the number of genes in the reference database, the percentage of genes actually detected remained almost identical in both studies. This consistency indicates that the sequencing depth allows for the capture of a similar fraction of the transcriptome.
...
<img src="img/plot3.png" alt="C" style="width:100%; max-width:900px; height:350px; object-fit:contain; display:block; margin:auto;"/>

<figcaption style="text-align:center; font-weight:600; margin-top:6px;">

figure 9: A comparison of DEA results shows a shift towards up-regulated genes with a decrease in the number of down-regulated genes compared to the article. The article used Baggerley's test and t-test on RPKM values, which are less rigorous in variance modeling. The DESeq2 package applies a variance shrinkage procedure. Increasing the number of genes tested from 26,000 to 50,000 imposed a stricter correction, which lowered the log2FoldChange of many genes and pushed them outside the filtration range.
...
Figure 10: Plots created with code above from data generated with DAVID. All plots except the last one display the 5 terms with the highest enrichment. Higher-quality versions are available on our GitHub.
...
Figure 11: Plots created using enrichGO and visualised with enrichplot. All plots except the last one display the 10 terms with the highest enrichment. Higher-quality versions are available on our GitHub.
...
During this project we were able to observed progress that bioinformatics tools and data bases have made in last 15 years.

The results may differ due to tools version, genome reference bias and pipelines. This draws two important conclusion:

-   always document your pipeline and tool versions. Try to make documentation as easy to find as possible - this ensures reproducible results and allows better comparison

-   The bioinformatics is computational science field. It is important to validate results experimentally if possible.

    With Bioinformatics methods we are able to crunch big amounts of data, see bigger picture and narrow down the search area for many scientific questions but the wet lab is still necessary part of most science experiments. \[7\] \[8\]
...
-   Kaja Łucka - she wrote an introduction, performed enrichment analysis with DAVID, KEGG and GEO

-   Tomasz Medoń - meta-data specialist, performed DEG analysis and compered its results to original study

All of the members added their parts to the slides show of presentation and participated in looking for the right aritcle
...
\[7\] Clarke, Robert, John J Tyson, Ming Tan, William T Baumann, Lu Jin, Jianhua Xuan, and Yue Wang. 2019. ‘Systems Biology: Perspectives on Multiscale Modeling in Research on Endocrine-Related Cancers’. Endocrine-related cancer 26(6): R345–68. Doi:10.1530/ERC-18-0309.

\[8\] Jafari, Mohieddin, Yuanfang Guan, David C. Wedge, and Naser Ansari-Pour. 2021. ‘Re-Evaluating Experimental Validation in the Big Data Era: A Conceptual Argument’. Genome Biology 22: 71. doi:10.1186/s13059-021-02292-4.
